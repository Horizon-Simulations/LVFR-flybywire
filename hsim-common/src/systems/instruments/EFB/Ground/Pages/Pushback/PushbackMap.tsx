...
export const PushbackMap = () => {
  ...
  const mapConfigPath = useMemo(() => {
    switch (airframeInfo.variant) {
      case (AirframeType.A318_115 | AirframeType.A318_115_ACJ | AirframeType.A318_115_BAW):
        return '/Pages/VCockpit/Instruments/Airliners/lvfr-horizonsim-airbus-a318-ceo/EFB/';
      case (AirframeType.A319_115 | AirframeType.A319_115_ACJ | AirframeType.A319_133 | AirframeType.A319_133_ACJ):
        return '/Pages/VCockpit/Instruments/Airliners/lvfr-horizonsim-airbus-a319-ceo/EFB/';
    case (AirframeType.A320_214 | AirframeType.A320_214_SL | AirframeType.A320_232 | AirframeType.A320_232_SL):
        return '/Pages/VCockpit/Instruments/Airliners/lvfr-horizonsim-airbus-a320-ceo/EFB/';
    case (AirframeType.A321_251N | AirframeType.A321_251N_LR | AirframeType.A321_271N | AirframeType.A321_271N_LR):
        return '/Pages/VCockpit/Instruments/Airliners/lvfr-horizonsim-airbus-a321-neo/EFB/';
      default:
        return '/Pages/VCockpit/Instruments/Airliners/lvfr-horizonsim-airbus-a320-ceo/EFB/';
    }
  }, [airframeInfo]);
