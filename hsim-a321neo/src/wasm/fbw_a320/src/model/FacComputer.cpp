...
void FacComputer::FacComputer_LagFilter(real_T rtu_U, real_T rtu_C1, real_T rtu_dt, real_T* rty_Y, rtDW_LagFilter_FacComputer_T* localDW) {
  real_T ca;
  real_T denom_tmp;
...
void FacComputer::FacComputer_RateLimiter(real_T rtu_u,
                                          real_T rtu_up,
                                          real_T rtu_lo,
                                          real_T rtu_Ts,
                                          boolean_T rtu_reset,
                                          real_T* rty_Y,
                                          rtDW_RateLimiter_FacComputer_T* localDW) {
  ...
  if (rtu_reset) {
    ...
    *rty_Y = std::fmax(std::fmin(rtu_u - localDW->pY, std::abs(rtu_up) * rtu_Ts), -std::abs(rtu_lo) * rtu_Ts) + localDW->pY;
  }

  localDW->pY = *rty_Y;
}

void FacComputer::FacComputer_CalculateV_alpha_max(real_T rtu_v_ias,
                                                   real_T rtu_alpha,
                                                   real_T rtu_alpha_0,
                                                   real_T rtu_alpha_target,
                                                   real_T* rty_V_alpha_target) {
...
void FacComputer::FacComputer_LagFilter_k(real32_T rtu_U,
                                          real_T rtu_C1,
                                          real_T rtu_dt,
                                          real32_T* rty_Y,
  ...
  denom_tmp = rtu_dt * rtu_C1;
  ca = denom_tmp / (denom_tmp + 2.0);
  *rty_Y = static_cast<real32_T>((2.0 - denom_tmp) / (denom_tmp + 2.0)) * localDW->pY +
           (rtu_U * static_cast<real32_T>(ca) + localDW->pU * static_cast<real32_T>(ca));
  localDW->pY = *rty_Y;
  localDW->pU = rtu_U;
}
...
void FacComputer::FacComputer_RateLimiter_f(real_T rtu_u,
                                            real_T rtu_up,
                                            real_T rtu_lo,
                                            real_T rtu_Ts,
                                            real_T rtu_init,
                                            boolean_T rtu_reset,
                                            real_T* rty_Y,
                                            rtDW_RateLimiter_FacComputer_b_T* localDW) {
  if ((!localDW->pY_not_empty) || rtu_reset) {
    localDW->pY = rtu_init;
    localDW->pY_not_empty = true;
  }
...
void FacComputer::FacComputer_RateLimiter_p(real_T rtu_u,
                                            real_T rtu_up,
                                            real_T rtu_lo,
                                            real_T rtu_Ts,
                                            real_T rtu_init,
                                            boolean_T rtu_reset,
                                            real_T* rty_Y,
                                            rtDW_RateLimiter_FacComputer_d_T* localDW) {
  if ((!localDW->pY_not_empty) || rtu_reset) {
    localDW->pY = rtu_init;
    localDW->pY_not_empty = true;
  }
...
void FacComputer::FacComputer_MATLABFunction_p(boolean_T rtu_u,
                                               real_T rtu_Ts,
                                               boolean_T rtu_isRisingEdge,
                                               real_T rtu_timeDelay,
                                               boolean_T* rty_y,
                                               rtDW_MATLABFunction_FacComputer_f_T* localDW) {
...
void FacComputer::step() {
  ...
  if (FacComputer_U.in.sim_data.computer_running) {
    ...
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2, FacComputer_P.BitfromLabel_bit, &rtb_y_ep);
    FacComputer_MATLABFunction_p((FacComputer_U.in.discrete_inputs.nose_gear_pressed == (rtb_y_ep != 0U)), FacComputer_U.in.time.dt,
                                 FacComputer_P.ConfirmNode_isRisingEdge, FacComputer_P.ConfirmNode_timeDelay, &rtb_y_ool,
                                 &FacComputer_DWork.sf_MATLABFunction_a);
    rtb_Memory = (rtb_y_b4 && rtb_y_ool);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2, FacComputer_P.BitfromLabel5_bit, &rtb_y_p);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_2, FacComputer_P.BitfromLabel6_bit, &rtb_y_l2);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_3, FacComputer_P.BitfromLabel7_bit, &rtb_y_ph);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.lgciu_own_bus.discrete_word_3, FacComputer_P.BitfromLabel8_bit, &rtb_y_ig);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel1_bit, &rtb_y_ep);
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, &rtb_y_b4);
    rtb_AND1 = ((rtb_y_ep != 0U) && rtb_y_b4);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel4_bit, &rtb_y_m);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel3_bit, &rtb_y_k);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel2_bit, &rtb_y_ep);
    if (rtb_Memory) {
      rtb_y_b4 = (rtb_y_p != 0U);
    ...
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel1_bit_d, &rtb_y_ep);
    ...
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel8_bit_i, &rtb_y_p);
    rtb_DataTypeConversion_gi = (rtb_y_p != 0U);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel9_bit, &rtb_y_l2);
    rtb_DataTypeConversion_l5 = (rtb_y_l2 != 0U);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel10_bit, &rtb_y_ph);
    rtb_DataTypeConversion_o = (rtb_y_ph != 0U);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel11_bit, &rtb_y_ig);
    rtb_DataTypeConversion_f5 = (rtb_y_ig != 0U);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.fac_opp_bus.discrete_word_5, FacComputer_P.BitfromLabel12_bit, &rtb_y_ep);
    ...
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_actual_position_word, FacComputer_P.BitfromLabel_bit_m,
                                 &rtb_y_ep);
    FacComputer_MATLABFunction_p((FacComputer_U.in.discrete_inputs.slats_extended != (rtb_y_ep != 0U)), FacComputer_U.in.time.dt,
                                 FacComputer_P.ConfirmNode_isRisingEdge_a, FacComputer_P.ConfirmNode_timeDelay_m, &rtb_y_ool,
                                 &FacComputer_DWork.sf_MATLABFunction_jf);
    rtb_DataTypeConversion_kr = (rtb_Memory && rtb_y_ool);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word, FacComputer_P.BitfromLabel2_bit_n,
                                 &rtb_y_ep);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word, FacComputer_P.BitfromLabel3_bit_i,
                                 &rtb_y_ig);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word, FacComputer_P.BitfromLabel4_bit_p,
                                 &rtb_y_ph);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word, FacComputer_P.BitfromLabel5_bit_g,
                                 &rtb_y_m);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word, FacComputer_P.BitfromLabel6_bit_n,
                                 &rtb_y_p);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.sfcc_own_bus.slat_flap_system_status_word, FacComputer_P.BitfromLabel7_bit_p,
                                 &rtb_y_l2);
    ...
    rtb_Memory =
        ((FacComputer_U.in.bus_inputs.adr_own_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
    ...
    rtb_DataTypeConversion_gi =
        ((FacComputer_U.in.bus_inputs.adr_opp_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
         (FacComputer_U.in.bus_inputs.adr_opp_bus.aoa_corrected_deg.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)));
    rtb_DataTypeConversion_l5 =
        ((FacComputer_U.in.bus_inputs.adr_3_bus.airspeed_computed_kn.SSM == static_cast<uint32_T>(SignStatusMatrix::FailureWarning)) ||
    ...
    rtb_DataTypeConversion_o =
        ((FacComputer_U.in.bus_inputs.ir_own_bus.body_yaw_rate_deg_s.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
    ...
    rtb_DataTypeConversion_f5 =
        ((FacComputer_U.in.bus_inputs.ir_opp_bus.body_yaw_rate_deg_s.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
    ...
    rtb_DataTypeConversion_l3 =
        ((FacComputer_U.in.bus_inputs.ir_3_bus.body_yaw_rate_deg_s.SSM != static_cast<uint32_T>(SignStatusMatrix::NormalOperation)) ||
    ...
    yawDamperCanEngage =
        (FacComputer_U.in.discrete_inputs.yaw_damper_has_hyd_press && FacComputer_U.in.discrete_inputs.fac_engaged_from_switch);
    rtb_y_ool = !FacComputer_U.in.discrete_inputs.is_unit_1;
    yawDamperHasPriority =
    ...
    rudderTrimCanEngage =
        (FacComputer_U.in.discrete_inputs.rudder_trim_actuator_healthy && FacComputer_U.in.discrete_inputs.fac_engaged_from_switch);
    rudderTrimHasPriority =
        (FacComputer_U.in.discrete_inputs.is_unit_1 || (rtb_y_ool && (!FacComputer_U.in.discrete_inputs.rudder_trim_opp_engaged)));
    rtb_rudderTrimEngaged = (rudderTrimCanEngage && rudderTrimHasPriority);
    rudderTravelLimCanEngage =
        (FacComputer_U.in.discrete_inputs.rudder_travel_lim_actuator_healthy && FacComputer_U.in.discrete_inputs.fac_engaged_from_switch);
    rudderTravelLimHasPriority =
        (FacComputer_U.in.discrete_inputs.is_unit_1 || (rtb_y_ool && (!FacComputer_U.in.discrete_inputs.rudder_travel_lim_opp_engaged)));
    ...
    if (rtb_V_ias >= 30.0F) {
      rtb_beta = rtb_n_y * 9.81 / (Vcas * Vcas * 0.6125 * 122.0 / (70000.0 * Vcas) * -0.62 * Vcas) * 180.0 / 3.1415926535897931;
    } else {
      rtb_beta = 0.0;
    }

    FacComputer_LagFilter(rtb_beta, FacComputer_P.LagFilter1_C1, FacComputer_U.in.time.dt, &Vcas, &FacComputer_DWork.sf_LagFilter_d);
    FacComputer_LagFilter_k(
        FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_right_percent.Data - FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_left_percent.Data,
        FacComputer_P.LagFilter1_C1_d, FacComputer_U.in.time.dt, &rtb_y_mb, &FacComputer_DWork.sf_LagFilter_k);
    ...
    FacComputer_LagFilter(u0, FacComputer_P.LagFilter2_C1, FacComputer_U.in.time.dt, &rtb_Switch1, &FacComputer_DWork.sf_LagFilter_f);
    FacComputer_LagFilter_k(
        FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_left_percent.Data - FacComputer_U.in.bus_inputs.fmgc_own_bus.n1_right_percent.Data,
        FacComputer_P.LagFilter3_C1, FacComputer_U.in.time.dt, &rtb_y_a, &FacComputer_DWork.sf_LagFilter_d5);
    ...
    rtb_beta = (rtb_Switch1 * rtb_y_a * FacComputer_P.Gain5_Gain + FacComputer_P.Gain4_Gain * rtb_y_mb) / rtb_Y_g4 / rtb_Y_g4 *
               FacComputer_P.Gain_Gain_k;
    FacComputer_LagFilter(static_cast<real_T>(rtb_alpha), FacComputer_P.LagFilter_C1, FacComputer_U.in.time.dt, &rtb_Y_g4,
                          &FacComputer_DWork.sf_LagFilter_c);
    rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg = rtb_Y_g4;
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_2, FacComputer_P.BitfromLabel6_bit_m,
                                 &rtb_y_ep);
    rtb_y_ool = (rtb_y_ep != 0U);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_2, FacComputer_P.BitfromLabel7_bit_i,
                                 &rtb_y_ep);
    rtb_DataTypeConversion_kr = (rtb_y_ep != 0U);
    rtb_y_ool = (rtb_y_ool || (rtb_y_ep != 0U));
    FacComputer_RateLimiter(
        look2_binlxpw(static_cast<real_T>(rtb_mach), static_cast<real_T>(rtb_Switch_i_idx_0), FacComputer_P.alphafloor_bp01Data,
                      FacComputer_P.alphafloor_bp02Data, FacComputer_P.alphafloor_tableData, FacComputer_P.alphafloor_maxIndex, 4U),
        FacComputer_P.RateLimiterGenericVariableTs1_up, FacComputer_P.RateLimiterGenericVariableTs1_lo, FacComputer_U.in.time.dt,
        FacComputer_P.reset_Value, &rtb_Switch1, &FacComputer_DWork.sf_RateLimiter);
    rtb_Gain = FacComputer_P.DiscreteDerivativeVariableTs_Gain * rtb_V_ias;
    rtb_Y_g4 = rtb_Gain - FacComputer_DWork.Delay_DSTATE;
    FacComputer_LagFilter(rtb_Y_g4 / FacComputer_U.in.time.dt, FacComputer_P.LagFilter_C1_k, FacComputer_U.in.time.dt, &rtb_Y_g4,
                          &FacComputer_DWork.sf_LagFilter);
    ...
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1, &rtb_DataTypeConversion_kr);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1, FacComputer_P.BitfromLabel9_bit_l,
                                 &rtb_y_ep);
    rtb_AND1_f = ((rtb_y_ep != 0U) && rtb_DataTypeConversion_kr);
    FacComputer_MATLABFunction(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1, &rtb_DataTypeConversion_kr);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1, FacComputer_P.BitfromLabel8_bit_ip,
                                 &rtb_y_ep);
    ...
    if ((rtb_alpha_floor_inhib == 0) && (rtb_mach < 0.6)) {
      ...
      if ((rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg >
           rtb_Switch1 + std::fmin(std::fmax(rtb_Y_g4, static_cast<real_T>(rtb_v_ls_kn_SSM)), 0.0)) &&
    ...
    FacComputer_RateLimiter(
        look1_binlxpw(static_cast<real_T>(rtb_Switch_i_idx_0), FacComputer_P.alpha0_bp01Data, FacComputer_P.alpha0_tableData, 5U),
        FacComputer_P.RateLimiterGenericVariableTs1_up_g, FacComputer_P.RateLimiterGenericVariableTs1_lo_n, FacComputer_U.in.time.dt,
        FacComputer_P.reset_Value_k, &rtb_Switch4_f, &FacComputer_DWork.sf_RateLimiter_c);
    FacComputer_RateLimiter(
        look2_binlxpw(static_cast<real_T>(rtb_mach), static_cast<real_T>(rtb_Switch_i_idx_0), FacComputer_P.alphamax_bp01Data,
                      FacComputer_P.alphamax_bp02Data, FacComputer_P.alphamax_tableData, FacComputer_P.alphamax_maxIndex, 4U),
        FacComputer_P.RateLimiterGenericVariableTs4_up, FacComputer_P.RateLimiterGenericVariableTs4_lo, FacComputer_U.in.time.dt,
        FacComputer_P.reset_Value_o, &rtb_Switch1, &FacComputer_DWork.sf_RateLimiter_a);
    FacComputer_CalculateV_alpha_max(static_cast<real_T>(rtb_V_ias), rtb_BusAssignment_d_flight_envelope_alpha_filtered_deg, rtb_Switch4_f,
                                     rtb_Switch1, &rtb_BusAssignment_f_flight_envelope_v_alpha_max_kn);
    ...
    FacComputer_MATLABFunction2(look1_binlxpw(static_cast<real_T>(rtb_Switch_i_idx_0), FacComputer_P.uDLookupTable3_bp01Data,
                                              FacComputer_P.uDLookupTable3_tableData, 5U),
                                look1_binlxpw(static_cast<real_T>(rtb_Switch_i_idx_0), FacComputer_P.uDLookupTable2_bp01Data,
                                              FacComputer_P.uDLookupTable2_tableData, 5U),
                                static_cast<real_T>(rtb_DataTypeConversion2), &rtb_Y_g4);
    FacComputer_RateLimiter_f(rtb_Y_g4, FacComputer_P.RateLimiterGenericVariableTs1_up_d, FacComputer_P.RateLimiterGenericVariableTs1_lo_f,
                              FacComputer_U.in.time.dt, FacComputer_P.RateLimiterGenericVariableTs1_InitialCondition,
                              FacComputer_P.reset_Value_k5, &rtb_Y_br, &FacComputer_DWork.sf_RateLimiter_g0);
    FacComputer_MATLABFunction_l(&FacComputer_U.in.bus_inputs.elac_1_bus.speedbrake_extension_deg, &rtb_DataTypeConversion_kr);
    ...
    rtb_Switch1 =
        look2_pbinlxpw(std::fmax(rtb_Switch4_f - (rtb_Switch4_f - -6.5) / (rtb_Switch1 - -405.0) * (rtb_Switch1 - 25.0), 1.0), u0,
                       FacComputer_P.uDLookupTable_bp01Data_g, FacComputer_P.uDLookupTable_bp02Data,
    ...
    FacComputer_RateLimiter_f(u0, FacComputer_P.RateLimiterGenericVariableTs_up, FacComputer_P.RateLimiterGenericVariableTs_lo,
                              FacComputer_U.in.time.dt, FacComputer_P.RateLimiterGenericVariableTs_InitialCondition,
                              FacComputer_P.reset_Value_m, &rtb_Switch4_f, &FacComputer_DWork.sf_RateLimiter_g);
    rtb_Switch4_f *= rtb_Y_br;
    if (rtb_alt >= FacComputer_P.CompareToConstant_const) {
      u0 = std::sqrt(
               std::pow((std::pow(rtb_Switch1 * rtb_Switch1 * 0.2 + 1.0, 3.5) - 1.0) * (rtb_p_s_c / 1013.25) + 1.0, 0.2857142857142857) -
               1.0) *
           1479.1;
    } else {
    ...
    rtb_Switch_b = look1_binlxpw(rtb_Y_g4, FacComputer_P.uDLookupTable_bp01Data, FacComputer_P.uDLookupTable_tableData, 1U) + rtb_Switch1;
    FacComputer_MATLABFunction2(
        look1_binlxpw(FacComputer_P.Constant_Value_k, FacComputer_P.uDLookupTable6_bp01Data, FacComputer_P.uDLookupTable6_tableData, 5U),
        look1_binlxpw(FacComputer_P.Constant_Value_k, FacComputer_P.uDLookupTable5_bp01Data, FacComputer_P.uDLookupTable5_tableData, 5U),
        static_cast<real_T>(rtb_DataTypeConversion2), &rtb_Switch1);
    rtb_Switch1 = std::fmax(FacComputer_P.Gain1_Gain * rtb_Switch1, FacComputer_P.Vmcl_Value_a + FacComputer_P.Bias_Bias);
    FacComputer_MATLABFunction2(
        look1_binlxpw(FacComputer_P.Constant1_Value_h, FacComputer_P.uDLookupTable8_bp01Data, FacComputer_P.uDLookupTable8_tableData, 5U),
        look1_binlxpw(FacComputer_P.Constant1_Value_h, FacComputer_P.uDLookupTable7_bp01Data, FacComputer_P.uDLookupTable7_tableData, 5U),
        static_cast<real_T>(rtb_DataTypeConversion2), &rtb_Switch4_f);
    rtb_Switch4_f = std::fmax(FacComputer_P.Gain_Gain_o * rtb_Switch4_f, FacComputer_P.Vmcl_Value_a + FacComputer_P.Bias2_Bias);
    rtb_v_gd = (rtb_Gain_n * 1.5 + 110.0) + std::fmax(rtb_alt - 10000.0, 0.0) / 1000.0;
    rtb_BusAssignment_g5_flight_envelope_v_stall_kn = rtb_Y_br;
    rtb_DataTypeConversion_kr =
        ((rtb_Switch_i_idx_0 == FacComputer_P.CompareToConstant4_const) || (rtb_Switch_i_idx_0 == FacComputer_P.CompareToConstant2_const));
    rtb_AND1_f = ((rtb_Switch_i_idx_0 < FacComputer_P.CompareToConstant_const_i) && (rtb_alt <= FacComputer_P.CompareToConstant1_const_i));
    ...
    rtb_Switch4_j = std::fmin(
        std::fmin(u0, std::sqrt(std::pow((std::pow(FacComputer_P.Constant1_Value_p * FacComputer_P.Constant1_Value_p * 0.2 + 1.0, 3.5) -
                                          1.0) * (rtb_p_s_c / 1013.25) +
                                             1.0,
                                         0.2857142857142857) -
                                1.0) *
                          1479.1),
        look1_binlxpw(static_cast<real_T>(rtb_Switch_i_idx_0), FacComputer_P.uDLookupTable_bp01Data_a,
    ...
    FacComputer_LagFilter(rtb_Y_g4 / FacComputer_U.in.time.dt, FacComputer_P.LagFilter_C1_f, FacComputer_U.in.time.dt, &rtb_Y_br,
                          &FacComputer_DWork.sf_LagFilter_i);
    FacComputer_RateLimiter_f(rtb_Y_br, FacComputer_P.RateLimiterGenericVariableTs_up_g, FacComputer_P.RateLimiterGenericVariableTs_lo_e,
                              FacComputer_U.in.time.dt, FacComputer_P.RateLimiterGenericVariableTs_InitialCondition_o,
                              FacComputer_P.reset_Value_i3, &rtb_Y_g4, &FacComputer_DWork.sf_RateLimiter_f);
    rtb_Switch_o = FacComputer_P.Gain_Gain_j * rtb_Y_g4;
    rtb_BusAssignment_f_flight_envelope_v_4_visible =
        ((rtb_Switch_i_idx_0 == FacComputer_P.CompareToConstant3_const) || (rtb_Switch_i_idx_0 == FacComputer_P.CompareToConstant1_const));
    rtb_BusAssignment_f_flight_envelope_v_fe_next_kn = look1_binlxpw(
        static_cast<real_T>(rtb_Switch_i_idx_0), FacComputer_P.uDLookupTable1_bp01Data, FacComputer_P.uDLookupTable1_tableData, 5U);
    ...
    if (FacComputer_P.PulseNode_isRisingEdge) {
      rtb_y_fh = (rtb_AND && (!FacComputer_DWork.previousInput));
    } else {
      rtb_y_fh = ((!rtb_AND) && FacComputer_DWork.previousInput);
    }
    ...
    FacComputer_DWork.Memory_PreviousInput =
        FacComputer_P.Logic_table[(((FacComputer_U.in.discrete_inputs.rudder_trim_switch_left ||
                                     FacComputer_U.in.discrete_inputs.rudder_trim_switch_right || rtb_y_ool) +
                                    (static_cast<uint32_T>(rtb_y_fh) << 1))
                                   << 1) +
                                  FacComputer_DWork.Memory_PreviousInput];
    rtb_AND = !rtb_rudderTrimEngaged;
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1, FacComputer_P.BitfromLabel_bit_j,
                                 &rtb_y_ph);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1, FacComputer_P.BitfromLabel1_bit_e,
                                 &rtb_y_ig);
    if (rtb_y_ool) {
    ...
    FacComputer_RateLimiter_p(FacComputer_DWork.Delay_DSTATE_dc, FacComputer_P.RateLimiterGenericVariableTs_up_l,
                              ...
                              FacComputer_U.in.analog_inputs.rudder_trim_position_deg, rtb_AND, &rtb_Y_l,
                              &FacComputer_DWork.sf_RateLimiter_l);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1, FacComputer_P.BitfromLabel_bit_c,
                                 &rtb_y_ep);
    rtb_y_ool = (rtb_y_ep != 0U);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_1_bus.discrete_status_word_1, FacComputer_P.BitfromLabel1_bit_n,
                                 &rtb_y_ep);
    rtb_AND = (rtb_y_ool && FacComputer_U.in.discrete_inputs.elac_1_healthy && (rtb_y_ep != 0U));
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1, FacComputer_P.BitfromLabel3_bit_k,
                                 &rtb_y_ep);
    rtb_y_ool = (rtb_y_ep != 0U);
    FacComputer_MATLABFunction_g(&FacComputer_U.in.bus_inputs.elac_2_bus.discrete_status_word_1, FacComputer_P.BitfromLabel4_bit_k,
                                 &rtb_y_ep);
    ...
    FacComputer_DWork.pY =
        (2.0 - rtb_Y_g4) / (rtb_Y_g4 + 2.0) * FacComputer_DWork.pY + (rtb_r * rtb_Y_br - FacComputer_DWork.pU * rtb_Y_br);
    FacComputer_DWork.pU = rtb_r;
    ...
    FacComputer_RateLimiter_p(rtb_Y_g4, FacComputer_P.RateLimiterGenericVariableTs_up_a, FacComputer_P.RateLimiterGenericVariableTs_lo_f,
                              FacComputer_U.in.time.dt, FacComputer_U.in.analog_inputs.yaw_damper_position_deg, !rtb_yawDamperEngaged,
                              &rtb_Y_br, &FacComputer_DWork.sf_RateLimiter_fu);
    u0 = look1_binlxpw(static_cast<real_T>(rtb_V_ias), FacComputer_P.uDLookupTable_bp01Data_i, FacComputer_P.uDLookupTable_tableData_j, 6U);
    ...
    FacComputer_RateLimiter_p(u0, FacComputer_P.RateLimiterGenericVariableTs_up_c, FacComputer_P.RateLimiterGenericVariableTs_lo_p,
                              FacComputer_U.in.time.dt, FacComputer_U.in.analog_inputs.rudder_travel_lim_position_deg,
                              !rtb_rudderTravelLimEngaged, &rtb_Y_g4, &FacComputer_DWork.sf_RateLimiter_p);
    ...
    if (FacComputer_P.Constant_Value_b5) {
      ...
      if (rtb_BusAssignment_h_logic_speed_scale_visible && (rtb_Switch_i_idx_0 == FacComputer_P.CompareToConstant_const_k)) {
    ...
    FacComputer_Y.out.logic.tracking_mode_on =
        (FacComputer_U.in.sim_data.slew_on || FacComputer_U.in.sim_data.pause_on || FacComputer_U.in.sim_data.tracking_mode_on_override);
    FacComputer_Y.out.logic.double_self_detected_adr_failure =
        ((rtb_Memory && rtb_DataTypeConversion_gi) || (rtb_Memory && rtb_DataTypeConversion_l5) ||
         (rtb_DataTypeConversion_gi && rtb_DataTypeConversion_l5));
    FacComputer_Y.out.logic.double_self_detected_ir_failure =
        ((rtb_DataTypeConversion_o && rtb_DataTypeConversion_f5) || (rtb_DataTypeConversion_o && rtb_DataTypeConversion_l3) ||
    ...
    if (rtb_BusAssignment_m_logic_sfcc_own_valid) {
      ...
      FacComputer_Y.out.bus_outputs.fac_slat_angle_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant_Value);
    }

    FacComputer_Y.out.bus_outputs.fac_slat_angle_deg.Data = rtb_Switch_i_idx_2;
    if (rtb_BusAssignment_m_logic_sfcc_own_valid) {
      FacComputer_Y.out.bus_outputs.fac_flap_angle_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant1_Value);
    } else {
      FacComputer_Y.out.bus_outputs.fac_flap_angle_deg.SSM = static_cast<uint32_T>(FacComputer_P.EnumeratedConstant_Value);
    }
    ...
    FacComputer_Y.out.bus_outputs.rudder_travel_limit_command_deg.Data =
        static_cast<real32_T>(FacComputer_U.in.analog_inputs.rudder_travel_lim_position_deg);
    ...
    FacComputer_Y.out.bus_outputs.v_stall_warn_kn.Data = static_cast<real32_T>(rtb_BusAssignment_dj_flight_envelope_v_stall_warn_kn);
...
FacComputer::FacComputer() : FacComputer_U(), FacComputer_Y(), FacComputer_DWork() {}
