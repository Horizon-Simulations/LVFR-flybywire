...
import { A321251NLandingCalculator } from '@shared/performance/a21nhs_landing';
import { A321251NTakeoffPerformanceCalculator } from '@shared/performance/a21nhs_takeoff';
  ...
  <AircraftContext.Provider
    value={{
      performanceCalculators: {
        takeoff: new A321251NTakeoffPerformanceCalculator(),
        landing: new A321251NLandingCalculator(),
      },
      settingsPages: {
