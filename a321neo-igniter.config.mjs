    ...
    new TaskOfTasks('A21NHS', [
        ...
        new TaskOfTasks(
            ...
            [
                ...
                new ExecTask('copy-cmake-config', 'npm run build-a321neo:copy-cmake-config'),
                new TaskOfTasks(
                    'localization',
                    [
        ...
        new TaskOfTasks(
            ...
            [
                ...
                new ExecTask('extras-host', 'npm run build-a321neo:extras-host', [
                ...
                new ExecTask('sentry-client', 'npm run build-a321neo:sentry-client', [
                    'build-a321neo/src/systems/sentry-client',
                    'build-a321neo/out/lvfr-horizonsim-airbus-a321-neo/html_ui/JS/A21NHS/sentry-client',
                ]),
                new ExecTask('simbridge-client', 'npm run build-a321neo:simbridge-client', [
                ...
                new ExecTask('systems-host', 'npm run build-a321neo:systems-host', [
        ...
        new TaskOfTasks(
            'wasm',
            [
                new ExecTask('systems', 'npm run build-a321neo:systems', [
                ...
                new ExecTask('cpp-wasm-cmake', 'npm run build-a321neo:cpp-wasm-cmake', [
                    ...
                    'fbw-a32nx/src/wasm/fadec_a21n-leap',
                    'fbw-a32nx/src/wasm/fadec_a21n-pw',
                    'build-a321neo/out/lvfr-horizonsim-airbus-a321-neo/SimObjects/Airplanes/A321neoLEAP/panel/extra-backend-a32nx.wasm',
                    'build-a321neo/out/lvfr-horizonsim-airbus-a321-neo/SimObjects/Airplanes/A321neoLEAP/panel/fadec_a21n-leap.wasm',
                    'build-a321neo/out/lvfr-horizonsim-airbus-a321-neo/SimObjects/Airplanes/A321neoLEAP/panel/fadec_a21n-pw.wasm',
                ]),
            ],
            true,
        ),
        ...
        new TaskOfTasks(
            ...
            [
                ...
                new ExecTask('extra-backend-a32nx', 'npm run build-a321neo:copy-extra-backend-a32nx'),
